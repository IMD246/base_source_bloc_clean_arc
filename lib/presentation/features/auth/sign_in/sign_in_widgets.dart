...
class _ForgotPasswordButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Text(
      ...
      style: AppTextStyles.bodyLarge.primaryColor.underline.bold,
...
class _SignInErrorText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<SignInBloc, SignInState>(
      ...
      builder: (context, state) {
        if (state.failureReason == null || state.failureReason == SignInFailureReason.unknown) {
        ...
        return Container(
          ...
          child: Text(
            ...
            style: AppTextStyles.bodyMedium.toColor(AppColors.error),
          ),
        );
      },
    );
