...
abstract class $PagedListCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({List<T> items, int page, int pageSize, bool isLastPage});
}
...
class _$PagedListImpl<T> extends _PagedList<T> {
  ...
  @override
  String toString() {
    return 'PagedList<$T>(items: $items, page: $page, pageSize: $pageSize, isLastPage: $isLastPage)';
  }
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(_items), page, pageSize, isLastPage);
...
abstract class _PagedList<T> extends PagedList<T> {
  const factory _PagedList(
      ...
      final bool isLastPage}) = _$PagedListImpl<T>;
